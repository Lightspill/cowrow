...
// configuration step. It creates a namespace called `cowrow`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cowrow::cmake::project_name, cowrow::cmake::project_version) };
